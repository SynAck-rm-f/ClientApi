...
import com.timefeel.rxmovies.ui.core.ViewUtils;
...
public class ContainersLayout extends FrameLayout{
    ...
    @Nullable
    @BindView(R.id.activity_main__space_master) View spaceMaster;
    @Nullable
    @BindView(R.id.activity_main__space_details) View spaceDetails;
    @BindView(R.id.activity_main__frame_master) ViewGroup frameMaster;
    @BindView(R.id.activity_main__frame_details) ViewGroup frameDetails;
